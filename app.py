...
3. For "forecast", estimate the user's end-of-month spend and what categories need control. Use the provided 'budget' and 'days_left'.
4. For "upcomingBill", only include if any transaction has "isRecurring" true.
